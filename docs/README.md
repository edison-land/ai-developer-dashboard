...
- **最新完成里程碑**：v0.7.1 · 重点信号与来源展示完善
- **下一计划里程碑**：v0.8.0 · 现有能力名实一致
- **桌面产品化**：v1.0.0 · 暂缓
- **文档整理日期**：2026-07-29
...
| v0.8.0 | 现有能力名实一致 | 🟡 计划中 | [需求](versions/v0.8.0/requirements.md) | [完成情况](versions/v0.8.0/completion.md) | — |
| v0.9.0 | UI 回归保护 | 🟡 计划中 | [需求](versions/v0.9.0/requirements.md) | [完成情况](versions/v0.9.0/completion.md) | — |
